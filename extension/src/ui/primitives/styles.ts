...
.sk-menu { background: var(--sk-color-bg); color: var(--sk-color-fg); border: 1px solid var(--sk-color-border); border-radius: var(--sk-radius); box-shadow: 0 4px 16px color-mix(in srgb, var(--sk-color-fg) 20%, transparent); display: flex; flex-direction: column; min-width: 160px; padding: var(--sk-space-1); }
